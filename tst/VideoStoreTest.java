...
public class VideoStoreTest {
    ...
    public void testSingleNewReleaseStatementTotals() {
        ...
        statement.generate();
        assertEquals(9.0, statement.getTotal(), .01);
    ...
    public void testDualNewReleaseStatementTotals() {
        ...
        statement.generate();
        assertEquals(18.0, statement.getTotal(), .01);
    ...
    public void testSingleChildrensStatementTotals() {
        ...
        statement.generate();
        assertEquals(1.5, statement.getTotal(), .01);
    ...
    public void testMultipleRegularStatementTotals() {
        ...
        statement.generate();
        assertEquals(7.5, statement.getTotal(), .01);
